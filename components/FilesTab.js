  ...
  return (
    <div style={{ width: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div style={{ fontSize: 17, fontWeight: 600, color: '#f1f5f9' }}>Event Files</div>
        <button
          disabled
          title="Coming soon"
      ...
      <div className="glass-card" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '64px 24px', gap: 12 }}>
        ...
        <div style={{ fontSize: 16, color: '#f1f5f9', fontWeight: 500 }}>No files uploaded yet</div>
        <div style={{ fontSize: 15, color: '#94a3b8' }}>File uploads coming in a future update</div>
      </div>
    </div>
  )
}
